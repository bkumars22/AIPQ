...
async def main():
    ...
    try:
        result = await client.create_version(
            ...
            threshold=0.90,
            changed_by="kumar",
            change_message="Rubric fix: 5 cases from golden_dataset.json corrected to match real, "
                            "already-correct ARIA behavior (hint-word script mismatch + missing-problem "
                            "phrasing) -- re-evaluate all 33 real cases",
        )
